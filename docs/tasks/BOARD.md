...
| NOVA-005 | Mocks: static JSON per contract (consistent numbers) + schema and consistency tests | ready-for-review | Gemini | 004, 023 |
...
| NOVA-025 | Theme: add `on-action` text token (dark/light) and use it in Button primary instead of `text-[white]` | draft | — | 007 |
