...
> Pydantic mirrors: `backend/libs/nova_contracts` (so far: User, ApiError, LoginRequest, AuditEntry, Page, BrokerAccount, BrokerProfile, RateLimit, RateLimitUpdate), checked with `nova_testing.parity`.
