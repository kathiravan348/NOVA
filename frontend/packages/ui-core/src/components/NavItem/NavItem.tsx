  ...
  ({ icon, active = false, asChild = false, className, children, onClick, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        onClick={handleClick}
        className={cn(
          "flex items-center gap-3 w-full px-3 h-(--nav-item-height) rounded-md text-body font-sans text-text-secondary transition-colors hover:text-text-primary hover:bg-bg-raised/60 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-focus-ring cursor-pointer select-none text-left",
